...
export default function ChartVisualise() {
  ...
  const downloadChart = () => {
    if (chartRef.current && !chartType.startsWith('3d')) {
      ...
      showCustomAlert("3D chart download requires a screenshot tool to capture the visualization.");
    }
  };
  ...
  return (
    <div className="min-h-screen p-6 bg-gradient-to-br from-green-50 to-blue-50">
      <div className="max-w-6xl mx-auto my-10 p-8 bg-white rounded-2xl shadow-xl">
        <h2 className="text-4xl font-bold text-center text-gray-800 mb-8 bg-gradient-to-r from-green-600 to-blue-600 bg-clip-text">
          Chart Visualization
        </h2>
